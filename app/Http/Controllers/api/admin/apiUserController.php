...
class apiUserController extends Controller
{
    ...
    public function updateProfile(Request $data)
    {
        ...
        if ($check) {
            if (user_profile::where('uid', $data->header('signature'))->exists()) {
                ...
                return response()->json(['status' => '200', 'message' => "Your Profile was updated..!"]);
            } else {
            ...
            return response()->json(['status' => '403', 'message' => "Your access credentials wrong..!"]);
        }
    }
    ...
    public function createShippingAddress(Request $data)
    {
        ...
        if ($store->save()) {
            return response()->json(['status' => '200', 'message' => 'Your shipping address was created..!']);
        }
    ...
    public function updateShippingAddress(Request $data)
    {
        if (ship_address::where('id', $data->address_id)->exists()) {
            ...
            return response()->json(['status' => '200', 'message' => "Your ship address was updated..!"]);
        }
    }
    ...
    public function deleteShippingAddress(Request $data)
    {
        if (ship_address::where('id', $data->header('address_id'))->exists()) {
            ...
            if ($delteAddres->delete()) {
                return response()->json(['status' => '200', 'message' => "Your ship address was deleted..!"]);
            }
        }
    }
}
